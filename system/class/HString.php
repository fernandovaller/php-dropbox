...
class HString {
    ...
    public static function removePontuacao($string){
        $especiais= Array(".",",",";","!","@","#","%","¨","*","(",")","+","-","=",
        "§","$","|","\\",":","/","<",">","?","{","}","[","]","&","'",'"',"´","`","?",'“','”','$',"'","'");
    ...
    public static function removeAcentos2($string) {
        ...
        //Monto nome para url ou arquivos
        //limit de 10 palavras
        public static function nomeArquivo($titulo, $limit_words = 10){
            ...
            if($titulo){
                ...
                $titulo_raw = self::removeAventos2($titulo_raw);
                ...
                foreach($titulo_raw_array as $word){ $titulo_raw_a[] = trim($word); $i++; if($i >= $limit_words) break; }
